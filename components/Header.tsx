...
const Header = () => {
  ...
  const { handlePost } = useContext(EditorContext)
  ...
  return (
    <header className="flex w-full items-center h-[70px] px-8 justify-between shadow-sm relative bg-white dark:bg-dark-base transition">
      <Link href="/" className="relative z-10">
        <Image src="https://firebasestorage.googleapis.com/v0/b/image-blog-8612c.appspot.com/o/assets%2Flogo.svg?alt=media&token=d2d5a4c9-5bdd-4e59-8f4a-ebf322d76e47" width={24} height={24} alt="blog logo" />
      </Link>
      ...
      <div className="flex items-center relative z-10">
        ...
        {pathname === '/admin' && (
          ...
          >
            ...
            <span className="hidden md:block ml-2 font-semibold">Post</span>
          </button>
        )}
        {session ? (
