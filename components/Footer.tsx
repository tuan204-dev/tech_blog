...
const Footer: React.FC = () => {
  return (
    <footer className="border-t-style flex justify-between items-center bg-white dark:bg-[#121212] px-16 h-20 md:h-14 lg:px-10 md:px-4 w-full relative sm:max-w-[600px] md:max-w-[760px] lg:max-w-[1000px] max-w-[1200px] mx-auto">
