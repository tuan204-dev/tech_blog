  ...
  return (
    <div className="h-screen min-h-[800px] bg-white dark:bg-gray-900">
      <div className="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm mb-24">
            ...
            <div>
              ...
              <div className="mt-2">
                <input
                  ...
                  className="block w-full rounded-md border-0 py-1.5 text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-[#343a47] placeholder:text-gray-400 focus:ring-1 focus:ring-inset focus:ring-indigo-100 dark:focus:ring-indigo-500 sm:text-sm sm:leading-6 px-2 dark:bg-[#1d2432]"
                />
              </div>
            </div>
            <div>
