...
export default async function Home(props: IProps) {
  ...
  return (
    <div className="pt-10 pb-16 md:py-6 px-10 md:px-2 grid gap-y-16 md:gap-y-8 grid-cols-8 2xl:grid-cols-6 xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 content-evenly auto-rows-max">
      {posts?.map((post: any) => (
